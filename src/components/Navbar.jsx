      ...
      <div className="backgroundMain ">
        <div class="px-4 py-5 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md: px-24 1g:px-8">
          <div class="relative flex items-center justify-between">
              ...
              <ul class="flex items-center hidden space-x-8 lg:flex">
                <li>
                  <button
                    ...
                    tracking-wide text-white transition duration-200 rounded shadow-d
            ...
            <div class="1g:hidden z-40">
              <button
                aria-label="Open Menu"
                title="Open Menu"
                class="p-2 -mr-1 transition duration-200 rounded focus:out line-none
                focus: shadow-bout line"
